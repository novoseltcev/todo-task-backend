...
from src.account.domain.model import PasswordHash, AccessError, UnconfirmedEmailError
from src.error import NotFoundError, LoginError, DataUniqueError
...
class FakeUsers(AccountRepository, Mock):
    ...
    def create(self, user):
        ...
        user.reference = self.generate_id()
